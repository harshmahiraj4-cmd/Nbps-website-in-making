        ...
        <div className="max-w-container mx-auto px-6 md:px-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <motion.div variants={itemVariants} className="bg-gradient-to-br from-blue-950 to-blue-900 dark:from-[#161d30] dark:to-[#0f172a] p-5 md:p-10 rounded-[2.5rem] shadow-2xl flex flex-col justify-center text-center relative overflow-hidden min-h-[200px]">
                ...
                <span className="text-amber-400 text-[9px] md:text-sm font-bold uppercase tracking-widest mb-4 block">Total Admission Package</span>
                <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-3 mb-6">
                  <span className="text-white text-2xl sm:text-4xl lg:text-5xl font-extrabold" style={serifStyle}>₹4,050</span>
                  <span className="text-amber-400 text-sm sm:text-xl font-bold uppercase">to</span>
                  <span className="text-white text-2xl sm:text-4xl lg:text-5xl font-extrabold" style={serifStyle}>₹5,400</span>
                </div>
                <p className="text-blue-100 text-[10px] md:text-sm leading-relaxed" style={serifStyle}>
