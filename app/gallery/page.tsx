          ...
          {lightboxIndex !== null && (
            ...
            >
              ...
              >
                ...
                {/* Photo Content */}
                <div className="bg-white rounded-2xl overflow-hidden shadow-2xl flex-1 flex flex-col max-h-[90vh]">
                  <div className="relative flex-1 min-h-[50vh] bg-gray-100">
                  ...
                  <div className="p-6 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <div className="flex justify-between items-start gap-4">
                      <div>
                        <span className="text-xs font-bold text-secondary uppercase tracking-widest mb-1 block" style={serifStyle}>{filtered[lightboxIndex].category}</span>
                        <h3 className="text-2xl font-bold text-blue-950 dark:text-blue-100 mb-2" style={serifStyle}>{filtered[lightboxIndex].title}</h3>
                        <p className="text-on-surface-variant dark:text-gray-400" style={serifStyle}>{filtered[lightboxIndex].desc}</p>
                      </div>
